import { View, StyleSheet, Alert, Dimensions, Image, Text, RefreshControl, ActivityIndicator } from "react-native";
...
export default function HomeScreen() {
  ...
  const fetchPosts = useCallback(
    async (isRefresh = false) => {
      ...
      setLoading(true);
      try {
        const result = await firestore.getAllPosts(isRefresh ? undefined : lastDoc || undefined, 10);
  ...
  const renderItem = useCallback(({ item }: { item: Post }) => <ImageItem item={item} />, []);
